...
public class AdapterShoppingCheckout extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterShoppingCheckout(Context ctx, boolean is_cart, List<Cart> items) {
        this.ctx = ctx;
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_shopping_checkout, parent, false);
        vh = new ViewHolder(v);
        return vh;
    }
